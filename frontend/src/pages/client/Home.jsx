...
export default function Home() {
  const { data: products, isLoading: productsLoading, error: productsError, isError: isProductsError } = useQuery({
                  ...
                  <div className="block-widget-wrap">
                    ...
                    <div className="block-content">
                      {productsLoading ? (
                        ...
                        <div className="text-center py-5" style={{ background: '#fff5f5', borderRadius: '4px', border: '1px solid #ffe3e3', padding: '20px' }}>
                          <p style={{ color: '#e53e3e', margin: 0, fontWeight: '500' }}>
                            Failed to load trending products. Please make sure the backend server is running.
                          </p>
                          {productsError && <p style={{ color: '#777', fontSize: '12px', marginTop: '5px', marginBottom: 0 }}>{productsError.message}</p>}
                        </div>
                      ) : (
                        <div className="row">
            ...
            <section className="section section-padding top-border p-t-10 p-b-10 m-b-0">
              <div className="section-container">
                <div className="block block-image">
                  <div className="block-widget-wrap">
                    <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', flexWrap: 'wrap', gap: '24px', padding: '25px 0', width: '100%' }}>
                      {[1, 2, 3, 4, 5].map((num) => (
                        <div key={num} className="brand-logo-item" style={{ display: 'inline-block', width: '120px', textAlign: 'center' }}>
                          <Link to="/shop"> 
