          ...
          <div className="mobile-menu-wrapper" style={{ background: '#fff', borderTop: '1px solid #eee', padding: '20px', position: 'absolute', width: '100%', left: 0, zIndex: 9999 }}>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              ...
              {user ? (
                ...
                <li style={{ padding: '10px 0' }}><Link to="/admin" onClick={() => setMobileMenuOpen(false)} style={{ color: '#111', fontWeight: 600, textDecoration: 'none' }}>Login</Link></li>
              )}
            </ul>
          </div>
        )}
                ...
                <div className="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 header-right">
                  <div className="header-page-link">
                    ...
                    <div className="login-header icon" style={{ position: 'relative' }}>
                      <Link to="/admin" title={user ? "Hệ thống quản trị" : "Login"} style={{ color: 'inherit', display: 'flex', alignItems: 'center' }}>
                        <i className="icon-user" style={user ? { marginRight: '5px' } : {}}></i>
